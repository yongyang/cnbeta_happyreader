...
*/
    ...
    private void parse(Map<String, Object> jSONObject) {
        ...
        JSONObject commentShowJSNObject = (JSONObject)jSONObject.get("comment_show");
        this.setSid(Long.parseLong(commentShowJSNObject.get("sid").toString()));
        this.setComment(commentShowJSNObject.get("comment").toString());
        this.setHostNameShow(commentShowJSNObject.get("host_name_show").toString());
        this.setTitleShow(commentShowJSNObject.get("title_show").toString());

        String name = commentShowJSNObject.get("name").toString();
